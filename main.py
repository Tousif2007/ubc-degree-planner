...
majors_database = {
    "Data Science": {
        ...
        "grad_requirements": {
            # The core courses you'll tackle in second year and beyond
    ...
    "Biochemistry": {
        ...
        # You need these specific foundations to start the major
        "first_year_reqs": ["BIOL 112", ["CHEM 121", "CHEM 111"], ["MATH 100", "MATH 102", "MATH 104", "MATH 180"]],
        "grad_requirements": {
            # The essential classes to get your degree in Biochem
